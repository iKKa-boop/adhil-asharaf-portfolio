...
export const metadata: Metadata = {
  title: "Adhil Asharaf | Linux System Administrator",
  description:
    "Linux System Administrator specializing in server administration, virtualization, networking, and automation.",
};
